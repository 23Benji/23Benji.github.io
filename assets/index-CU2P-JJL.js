...
#define LOW_PRECISION`),t}function Ey(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===cp?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Y_?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Ei&&(t="SHADOWMAP_TYPE_VSM"),t}function Ty(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Ns:case Fs:t="ENVMAP_TYPE_CUBE";break;case ll:t="ENVMAP_TYPE_CUBE_UV";break}return t}function by(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Fs:t="ENVMAP_MODE_REFRACTION";break}return t}function wy(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case up:t="ENVMAP_BLENDING_MULTIPLY";break;case vg:t="ENVMAP_BLENDING_MIX";break;case xg:t="ENVMAP_BLENDING_ADD";break}return t}function Ay(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Ry(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Ey(e),c=Ty(e),u=by(e),h=wy(e),f=Ay(e),d=my(e),g=_y(s),_=i.createProgram();let p,m,M=e.glslVersion?"#version "+e.glslVersion+`
